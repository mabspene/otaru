        ...
        <div id="centerCol_Content">
            <div class="homeLinks" style="text-align:<?php echo lang('homeLinks'); ?>">
                <div align="center">
                    ...
                    <h3 style="margin:5px;font-size:18px;">
                        <?php echo "<a href='u/".$_SESSION['Username']."'>".$_SESSION['Fullname']."</a>"; 
                ...
                <a href="./mynotepad/new.php"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/270f.png" /> <?php echo lang('new_note'); ?></p></a>
                <?php
                $msid = $_SESSION['id'];
                ...
                while ($note_i = $get_notes->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    ?>
                    <a href="./mynotepad/"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/1f5d2.png" /> <?php
                            if (strlen($get_note_title) > 20 ) {
                ...
                <a href="./posts/saved.php"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/1f516.png" /> <?php echo lang('saved_posts'); ?></p></a>
